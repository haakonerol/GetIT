  ...
  app.innerHTML = `
        ...
        <div class="container">
            ...
            <div class="buttons">
                ...
                <button onclick="showPokemon(playerIndex)">Vis dine pokemon</button>
            </div>
        </div>
...
function showPokemon(trainer){
  let caughtPokemons = players[trainer].playerPokemons;
  let currentPlayer = players[trainer].playerName
  app.innerHTML = `
        <div class="caughtContainer">
    <h1>${currentPlayer} fanget :</h1>
    <ul>${caughtPokemons.map(pokemon=>`<li>${pokemon.pokemonName}</li>`)}
    </ul>
    <div class="buttonContainer">
              <button onclick="updateView()">Finn en annen</button>
